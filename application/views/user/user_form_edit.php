                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group <?=form_error('level') ? 'has-error' : null?>">
                            ...
                            <select name="level" class="form-control">
                                ...
                                <option value="1" <?=set_value('level', $row->level) == 1 ? "selected" : null?>>Super Admin</option>
                                <option value="2" <?=set_value('level', $row->level) == 2 ? "selected" : null?>>Admin</option>
                                <option value="3" <?=set_value('level', $row->level) == 3 ? "selected" : null?>>Kasir</option>
                                <option value="4" <?=set_value('level', $row->level) == 3 ? "selected" : null?>>Gudang</option>
                            </select>
                            <?=form_error('level')?>
                        </div>
