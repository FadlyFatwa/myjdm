...
<div class="pos-strip">
    ...
    <div class="strip-item" style="margin-left:auto;">
        <a href="<?= site_url('sale/full') ?>" class="btn btn-xs btn-info" style="white-space:nowrap;">
            <i class="fa fa-list-alt"></i> Mode Full
        </a>
    </div>
</div>
    ...
    function doFinalConfirm() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                type: 'POST',
                url: '<?=site_url('sale/process')?>',
                data: {'process_payment': true, 'mode': 'lite', 'customer_id': customer_id, 'customer_name': customer_name, 'subtotal': subtotal,
