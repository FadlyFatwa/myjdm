...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= site_url('kontra-bon/detail/' . $kb->kontra_bon_id) ?>"><?= $kb->kontra_bon_no ?></a></li>
    ...
    <div class="box box-success">
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a href="<?= site_url('kontra-bon/detail/' . $kb->kontra_bon_id) ?>" class="btn btn-warning btn-flat btn-sm">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="<?= site_url('kontra-bon-payment/process') ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <p class="help-block">Maksimal Rp <?= number_format($kb->outstanding_amount, 0, ',', '.') ?> (sisa tagihan).</p>
                        </div>
                        <div class="form-group">
