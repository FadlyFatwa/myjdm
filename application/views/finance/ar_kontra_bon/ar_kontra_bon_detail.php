...
<section class="content-header">
    <h1>Detail Kontra Bon
        <small><?= $kb->kontra_bon_no ?></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Finance</a></li>
        <li><a href="<?= site_url('kontra-bon') ?>">Kontra Bon</a></li>
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="pull-right">
                <a href="<?= site_url('kontra-bon/cetak/' . $kb->kontra_bon_id) ?>" target="_blank" class="btn btn-default btn-flat btn-sm">
                    <i class="fa fa-print"></i> Cetak
                </a>
                <a href="<?= site_url('kontra-bon') ?>" class="btn btn-warning btn-flat btn-sm">
        ...
        <div class="box-body">
            ...
            <?php if (in_array($kb->status, ['outstanding', 'partial'])): ?>
                <a href="<?= site_url('kontra-bon-payment/add/' . $kb->kontra_bon_id) ?>" class="btn btn-success">
        ...
        <div class="box-body table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a href="<?= site_url('ar-invoice/detail/' . $inv->ar_invoice_id) ?>"><?= $inv->ar_no ?></a></td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php if (!$p->is_void): ?>
                            <form method="post" action="<?= site_url('kontra-bon-payment/void/' . $p->kontra_bon_payment_id) ?>" onsubmit="return confirmVoidPayment(this);" style="display:inline-block;">
...
<div class="modal fade" id="modal-void">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <form method="post" action="<?= site_url('kontra-bon/void/' . $kb->kontra_bon_id) ?>">
                <div class="modal-body">
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name() ?>" value="<?= $this->security->get_csrf_hash() ?>">
                    <p>Semua nota di dalam kontra bon ini akan dilepas dan jatuh temponya dikembalikan sesuai termin customer.</p>
