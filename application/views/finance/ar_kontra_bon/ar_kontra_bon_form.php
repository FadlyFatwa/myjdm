...
<section class="content">
    <div class="box box-primary">
        ...
        <div class="box-body">
            <form action="<?= site_url('kontra-bon/add') ?>" method="post" id="form-kb">
                <div class="row">
                    <div class="col-md-4">
                ...
                <div id="preview-wrap" style="display:none;">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                            <tr>
                                <th colspan="4" class="text-right">Total Sisa</th>
                ...
                <div id="preview-empty" style="display:none;" class="alert alert-warning">
                    Tidak ada nota outstanding pada rentang tanggal ini untuk customer tersebut.
                </div>
            </form>
        </div>
    </div>
...
$(document).ready(function() {
    ...
    $('#btn-preview').on('click', function() {
        ...
        if (!customer_id || !period_start || !period_end) {
            Swal.fire({ icon: 'error', title: 'Lengkapi customer dan rentang tanggal dulu.' });
            return;
        }

        $.post('<?= site_url('kontra-bon/preview') ?>', {
    ...
    $('#customer_id, #period_start, #period_end').on('change', function() {
        $('#preview-wrap').hide();
        $('#preview-empty').hide();
        $('#btn-submit').prop('disabled', true);
    });
