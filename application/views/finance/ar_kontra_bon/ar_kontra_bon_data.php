...
<section class="content-header">
    <h1><i class="fa fa-clone text-primary"></i> Kontra Bon</h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title"><i class="fa fa-list"></i> Daftar Kontra Bon</h3>
            <?php if (in_array($this->session->userdata('level'), [1, 2])): ?>
            <div class="box-tools pull-right">
                <a href="<?= site_url('kontra-bon/add') ?>" class="btn btn-success btn-sm">
...
$(document).ready(function() {
    $('#table-kb').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?= site_url('kontra-bon/get_json') ?>',
            type: 'POST'
        },
        order: [[1, 'desc']],
        columns: [
            ...
            { data: null, orderable: false, className: 'text-center', render: function(d, t, r) {
                return '<a href="<?= site_url('kontra-bon/detail/') ?>' + r.kontra_bon_id + '" class="btn btn-xs btn-primary"><i class="fa fa-eye"></i></a>';
            }}
        ]
    });
});
